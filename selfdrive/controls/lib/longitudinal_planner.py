...
class LongitudinalPlanner:
  ...
  def update(self, sm):
    ...
    self.accel_controller.set_profile(self.params.get("sp_long_accel_profile", encoding='utf-8'))
    ...
    # sp - override accel using sp_long_accel_profile
    ...
    self.mpc.update(sm['radarState'], v_cruise, x, v, a, j, personality=sm['controlsState'].personality, use_df_tune=self.dynamic_follow)
